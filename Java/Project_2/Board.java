    ...
    public void printBoard(){
        ...
        for(int i=0;i<board.length;i++){
            for(int j=0;j<board[i].length;j++){
                if (i == 0 && j == 0){
                    for (int x = 0; x < board[i].length; x++){
                        if (x == 0){
                            for (int paddingI = 0; paddingI < board[0].length; paddingI++){
                                System.out.print(" ");
                            }
                    ...
                    for (int s = 0; s < board[i].length + 2; s++){
                        if (s == 0){
                            for (int paddingK = 0; paddingK < board[0].length; paddingK++){
                                System.out.print(" ");
                            }
                            System.out.print(" " + "\u2554");
                        }
                ...
                if(j==0){
                    for (int paddingL = 0; paddingL < board[0].length; paddingL++){
                        System.out.print(" ");
                    }
            ...
            for (int m = 0; m < board[i].length + 1; m++){
                if (m == 0){
                    for (int paddingJ = 0; paddingJ < board[0].length; paddingJ++){
                        System.out.print(" ");
                    }
                    System.out.print(" " + "\u2560");
                }
                    ...
                    for(int dX = xSpot - 1; dX < xSpot + 2; dX++){
                        ...
                        if (dX >= 0){
                            ...
                            if(dX == xSpot - 1){
                                if (dY == ySpot - 1){
                                    for (int droneColumnCounter = 0; droneColumnCounter < 3; droneColumnCounter++){
                                        if (droneColumnCounter == 0){
                                            for (int i = 0; i < board[0].length*1.5 - 2; i++){
                                                System.out.print(" ");
                                            }
                                ...
                                System.out.print(printer + " " + "\u255f" + dY + "   " + headerSpacing[headerI] + header[headerI] + '\n');
                                headerI++;
                            }
                            else{
                                System.out.print(printer + "  ");
